    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["dexter channels list", "List configured channels and auth profiles."],
          ["dexter channels status --probe", "Run channel status checks and probes."],
          [
            "dexter channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["dexter channels login --channel whatsapp", "Link a WhatsApp Web account."],
