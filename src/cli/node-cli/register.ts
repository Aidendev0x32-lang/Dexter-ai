    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          [
            "dexter node run --host 127.0.0.1 --port 18789",
            "Run the node host in the foreground.",
          ],
          ["dexter node status", "Check node host service status."],
          ["dexter node install", "Install the node host service."],
          ["dexter node restart", "Restart the installed node host service."],
