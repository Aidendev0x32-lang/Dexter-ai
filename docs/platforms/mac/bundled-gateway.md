...
- The CLI can also install it: `dexter gateway install`.
...
dexter gateway --port 18999 --bind loopback
```

Then:

```bash
dexter gateway call health --url ws://127.0.0.1:18999 --timeout 3000
```
