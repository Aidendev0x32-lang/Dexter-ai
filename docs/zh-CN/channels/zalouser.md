...
- 通过 CLI 安装：`dexter plugins install @openclaw/zalouser`
- 或从源码检出安装：`dexter plugins install ./extensions/zalouser`
- 详情：[插件](/tools/plugin)
...
- 重新登录：`dexter channels logout --channel zalouser && dexter channels login --channel zalouser`
