...
- Install via CLI: `dexter plugins install @openclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `dexter plugins install ./extensions/zalo`
   - From npm (if published): `dexter plugins install @openclaw/zalo`
...
- Approve via:
  - `dexter pairing list zalo`
  - `dexter pairing approve zalo <CODE>`
...
- Example: `dexter message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `dexter channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `dexter logs --follow`
