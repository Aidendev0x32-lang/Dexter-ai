export const usageStylesPart1 = `
  ...
  .usage-primary-btn:disabled {
    background: rgba(192, 200, 216, 0.18);
  ...
  .usage-primary-btn[disabled] {
    background: rgba(192, 200, 216, 0.18) !important;
    border-color: rgba(192, 200, 216, 0.3) !important;
  ...
  .usage-hour-cell.selected {
    border-color: rgba(192, 200, 216, 0.8);
    box-shadow: 0 0 0 2px rgba(192, 200, 216, 0.2);
  }
  .usage-hour-labels {
    display: grid;
