...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Edit ~/.openclaw/dexter.json safely.",
  ...
  wizard: {
    title: "Dexter Setup",
    welcomeTitle: "Welcome to Dexter",
    welcomeSubtitle: "Let's configure your AI assistant. This will take about a minute.",
    ...
    completeSubtitle: "Your assistant is ready. Redirecting to the control panel...",
